...
import { LAYOUT_CONSTANTS, IMAGE_CONSTANTS } from './constants';
...
export class WaterfallLayoutEngine {
  ...
  private normalizeImageData(item: ContentItem): ContentItem {
    ...
    // 确保尺寸在合理范围内
    if (width < IMAGE_CONSTANTS.DEFAULT_WIDTH || width > 800 ||
        height < IMAGE_CONSTANTS.MIN_HEIGHT || height > IMAGE_CONSTANTS.MAX_HEIGHT) {
